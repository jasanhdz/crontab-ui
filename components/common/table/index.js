...
function createData(name, description, scheduling, id, updated_at, created_at) {
...
export default function EnhancedTable(props) {
  const { items, headCells, title } = props 
  const rows = items.map(item => {
    const { id, name, scheduling, updated_at, created_at, description } = item
    return createData(name, description, scheduling, Number(id), updated_at, created_at)
  })
